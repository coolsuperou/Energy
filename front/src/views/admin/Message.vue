<template>
  <div class="message-page">
    ...
    <el-tabs v-model="activeTab" class="message-tabs" @tab-change="handleTabChange">
      ...
      <el-tab-pane label="系统告警" name="alert" />
...
function getTypeConfig(type) {
  const configMap = {
    user: { icon: 'bi bi-people', iconClass: 'primary' },
    alert: { icon: 'bi bi-exclamation-triangle', iconClass: 'warning' },
    log: { icon: 'bi bi-journal-text', iconClass: 'info' },
    system: { icon: 'bi bi-gear', iconClass: 'success' },
